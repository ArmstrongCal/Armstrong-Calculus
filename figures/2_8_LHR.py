...
beginfigure("2_8_LHR", 2*width, height)
...
label = Label(r"$L_g$", [3.1,-1.2], alignment = "lb", offset = [2, 2])
label.draw()

label = Label(r"$f$", [2.5,2], alignment = "lb", offset = [2, 2])
label.draw()

label = Label(r"$L_f$", [3,1.5], alignment = "lb", offset = [2, 2])
label.draw()
...
label = Label(r"$L_g \approx g$", [2.2,-0.2], alignment = "lb", offset = [0, 0])
label.draw()

label = Label(r"$L_f \approx f$", [2.125,0.2], alignment = "lb", offset = [2, 2])
label.draw()
