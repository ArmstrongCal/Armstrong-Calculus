...
grid = Grid([-2,0.5,2],  # initial x, x spacing, final x
            [-2,0.5,2])  # initial y, y spacing, final y
grid.setlinewidth(1)     # default is 1
grid.setcolor(lightgray) # default is black
grid.draw()
...
point = Point([a, derivative.value(a)], 2.5)
