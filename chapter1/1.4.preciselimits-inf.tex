...
\definition{The Limit of a Function $f$}  \label{D:1.4.precise}%DEFINITION 
...
%\input{examples/1-4_Eg1.tex} %EXAMPLE
...
%\input{examples/1-4_Eg2.tex} %EXAMPLE

%\input{examples/1-4_Eg3.tex} %EXAMPLE
...
%\includegraphics[scale=.4]{text/apex-limits_involving_infinity1.png}
...
%\input{examples/1-4_Eg4.tex} %EXAMPLE
...
%\input{examples/1-4_Eg5.tex} %EXAMPLE
